...
class InlineTooltipEditor extends React.Component {
  ...
  */
  ...
  render() {
          ...
          <div className="editor">
            ...
            {options && (
              <Select
                ...
                onChange={option =>
                  this.handleChange(option.hasOwnProperty('value') && option.value !== null ? option.value : option)
                }
              />
            )}
            {this.props.type && (
            ...
            <div className="buttons">
              <button className="btn btn-primary save" onClick={() => this.editParam(this.state.value)}>
                Save
              </button>
              <button
    ...
    return this.state.editing ? <span className="editor-area">{editor}</span> : childrenWithProps;
  }
}

InlineTooltipEditor.propTypes = {
  isEditorOpen: PropTypes.bool,
  toggleInlineEditor: PropTypes.func,
