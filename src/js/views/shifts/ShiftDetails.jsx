      ...
      switch (param) {
        ...
        default:
          swal({
            ...
            .then(result => {
              if (result.value) {
                if (value == null || value.length === 0 || (typeof value !== 'string' && isNaN(value)))
                  throw new Error();
                ShiftActions.updateShift(id, param, value);
                swal({
                  position: 'top',
      ...
      <div className="row shift-details">
        {shift.status === 'DRAFT' || this.state.editionMode ? (
          ...
          <div className="col col-md-9 first-col">
            ...
            {shift.status === 'DRAFT' && <h1>Draft</h1>}
        ...
        <div className="col second-col">
                  ...
                  <button
                    ...
                    onClick={() =>
                      swal({
                        ...
                        title: 'Are you sure?',
                        html:
                          'Once published, you will start receiving applicants and everyone on our network that matches the shift criteria will be notified.',
                        type: 'info',
                        showCloseButton: true,
                        showCancelButton: true,
          ...
          <div className="restriction">
            ...
            >
              <span className={shift.application_restriction === 'FAVORITES' ? 'favorite' : 'anyone'} />
            </InlineTooltipEditor>
          </div>
          ...
          {shift.application_restriction === 'FAVORITES' ? (
            <div className="allowed-lists">
              ...
              <ul>{shift.allowed_from_list.map(list => <li key={uuid()}>{list.title}</li>)}</ul>
            </div>
          ) : (
            <div className="allowed-lists">
          ...
          <div className="min-candidates">
            <div>
              ...
              >
                <span className="min-rating">{shift.minimum_allowed_rating}</span>
              </InlineTooltipEditor>
            </div>
          </div>
            ...
            <div className="tags-list">
              ...
              >
                {shift.required_badges.length > 0 ? (
                  shift.required_badges.map(({ title }) => (
